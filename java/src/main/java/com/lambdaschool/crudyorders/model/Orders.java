package com.lambdaschool.crudyorders.model;
...
public class Orders
{
    ...
    {
        this.ordamount = ord.ordamount;
        this.advanceamount = ord.advanceamount;
        this.ordersescription = ord.ordersescription;
        this.customer = ord.customer;
        this.agent = ord.agent;
    }
